...
public class RedBlackTree {
    ...
    public RedBlackNode findNode(int key) {
        if (this.root == RedBlackTree.nil) {
            return null;
        } else if (this.root.getKey() < key) {
        	return this.root.getLeftChild().findNode(key);
        } else if (this.root.getKey() > key) {
        	return this.root.getRightChild().findNode(key);
        } else
        	return this.root;
    }
    ...
    public void deleteNode(RedBlackNode z) {
        ...
        if (z.getLeftChild() == RedBlackTree.nil) {
            ...
            if (y.getParent() == z) {
                ...
                y.setRightChild(z.getRightChild()); // left->right
        ...
        while (x != this.root && x.getColor() == Color.BLACK) {
            if (x == x.getParent().getLeftChild()) {
                ...
                if (w.getColor() == Color.RED) {
                    ...
                    x.getParent().setColor(Color.RED);	//change from BLACK to RED
    ...
    public boolean isValid() {
        ...
        if (!this.hasValidBlackHeights(this.root)) {
        	System.out.println("not valid black-height");
            return false;
        }
