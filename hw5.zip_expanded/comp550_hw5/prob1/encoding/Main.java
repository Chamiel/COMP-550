...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        runEncoder(fwe, syllabusText);

        // Huffman encoder based on assignment.txt character frequencies
        HashMap<Character, Float> assignmentFrequencies = buildFrequencyTable(assignmentText);
        ...
        runEncoder(he, syllabusText);

        // Huffman encoder based on syllabus.txt character frequencies
        HashMap<Character, Float> syllabusFrequencies = buildFrequencyTable(syllabusText);
        ...
        runEncoder(he2, syllabusText);
        
        // Huffman encoder based on random.txt character frequencies
        HashMap<Character, Float> randomFrequencies = buildFrequencyTable(randomText);
        HuffmanEncoder random = new HuffmanEncoder(randomFrequencies);
        runEncoder(random, syllabusText);
    }
}
